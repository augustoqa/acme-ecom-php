<div class="off-canvas position-left reveal-for-large nav" id="offCanvas" data-off-canvas>
    ...
    <ul class="vertical menu">
        ...
        <li><a href="/admin/users/payments"><i class="fas fa-hand-holding-usd"></i>&nbsp; Payments</a></li>
        <li><a href="/admin/logout"><i class="fas fa-sign-out-alt"></i>&nbsp; Logout</a></li>
    </ul>
    <!-- end Side bar -->
</div><?php /**PATH C:\laragon\www\acme-ecommerce\resources\views/includes/admin-sidebar.blade.php ENDPATH**/ ?>